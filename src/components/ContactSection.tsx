            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-base sm:text-lg font-display font-medium text-foreground truncate">+91 808 720 5660</p>
                </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs sm:text-base md:text-lg font-display font-medium text-foreground truncate">mayuraimaker@gmail.com</p>
                </div>
